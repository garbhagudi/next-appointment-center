...
Appointment_DB_router.get("/:id", async (req: Request, res: Response) => {
    ...
    try {
        ...
        const appointment = (await Appointment_DB_C.Appointment_DB.findOne(query)) as Appointment_DB;
...
Appointment_DB_router.post("/", async (req: Request, res: Response) => {
    try {
        ...
        const result = await Appointment_DB_C.Appointment_DB.insertOne(newAppointment);
...
Appointment_DB_router.put("/:id", async (req: Request, res: Response) => {
    ...
    try {
        ...
        const result = await Appointment_DB_C.Appointment_DB.updateOne(query, { $set: updatedAppointment });
